...
| G2 | **Filter clicks feel slow** — range changes recompute the whole page | Feels laggy/unresponsive even though data is correct; gets worse as volume grows | Keep "real data only"; no fake instant numbers; show honest "updating…" state |
